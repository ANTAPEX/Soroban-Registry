          ...
          <table className="min-w-full divide-y divide-border">
            <thead>
              <tr>
                <th
                  scope="col"
                  className="px-3 sm:px-6 py-3 text-left eyebrow font-normal"
                >
                  Publisher
                </th>
                <th
                  scope="col"
                  className="px-3 sm:px-6 py-3 text-right eyebrow font-normal"
                >
                  Contracts
                </th>
              </tr>
            ...
            <tbody className="bg-card divide-y divide-border">
              {data.map((publisher, index) => (
                <tr key={index} className="hover:bg-accent transition-colors">
                  ...
                  <td className="px-3 sm:px-6 py-4 whitespace-nowrap font-mono text-sm tabular-nums text-right text-muted-foreground">
